    ...
    return(
        <div className="p-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 overflow-visible">
                <div>
                    <div className="bg-center bg-no-repeat h-fit bg-cover bg-zinc-700 hover:bg-[url(../assets/Images/pl_1.png)] p-7 text-start group">
                    ...
                    <a href="#" className="w-full py-3 px-7 bg-black group-hover:bg-amber-500 text-white border-1 rounded-md transition-all duration-500 ease-in-out border-solid">Get Your Plan Done</a>
                </div>
                </div>

                <div>
                    <div className="bg-center bg-no-repeat h-fit bg-cover p-7 text-start group " style={{backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${pl_1})`}}>
                    <h3 className="text-yellow-500 font-bold">$<span className="text-8xl">590</span>00</h3><br/>
                    <h2>Basic Plan</h2>
                    <p>Basic Plan</p><br/>
                    <div>
                    ...
                    <a href="#" className="w-full py-3 px-7 bg-black text-white border-1 rounded-md transition-all duration-500 ease-in-out border-solid">Get Your Plan Done</a>
                </div>
                </div>
