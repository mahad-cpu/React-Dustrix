...
export default function NewsLetter() {
  return (
    <div className="w-full flex flex-row">
      <div className="hidden lg:block w-[40%] bg-cover bg-center bg-no-repeat " style={{ backgroundImage: `url(${nl_1})` }}>
        
      </div>
      <div className="w-full lg:w-[60%] bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${nl_2})`}}>
