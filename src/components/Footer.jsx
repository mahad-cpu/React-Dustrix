        ...
        <footer className="w-full flex flex-col items-center">
            <div className="bg-black w-full p-10 grid grid-cols-2 lg:grid-cols-4 gap-5 text-start">
                    ...
                    <div class="flex flex-col gap-3">
                        <div className="flex flex-row gap-3">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="font-bold text-xs hover:text-amber-500">The Most Successful Engineering Contractor</span>
                            </div>
                        </div>
                        <div className="flex flex-row gap-3">
                ...
                <div>
                    ...
                    <form>
                        <input type="email" className="rounded-md w-full h-[56px] pl-5 text-xs border-white my-7" placeholder="Enter email address"/>
                    </form>
                </div>
                <div>
                    ...
                    <div class="flex flex-col gap-3">
                        <div className="flex flex-row gap-3 py-1">
                            <div className="w-[36px] h-[36px] rounded-md bg-amber-500 flex flex-row items-center justify-center p-2 hover:bg-black">
                                <img src={phone} />
                            </div>
                            <div className="flex flex-col">
            ...
            <div className="w-full flex flex-row items-center px-7 bg-amber-500 justify-between">
                <div className="justify-self-start">
                    <h6>© Copyright By Dustrix - 2021</h6>
                </div>
                <div className="justify-self-center bg-zinc-900 px-10 py-7">
                    <a href="#"><img alt="logo" src={logo}/></a>
                </div>
                <div className="justify-self-end">
                    <button className="p-3 rounded-md bg-black"><img src={arrow} alt="Top" className="h-[16px]"/></button>
                </div>
            </div>
        </footer>
    )
