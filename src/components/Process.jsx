            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 w-full max-w-7xl">
                <div className="p-7">
                    <div className="p-12 relative">
                        ...
                        <img src={p_3} className="hidden absolute bottom-0 right-0 border-8 border-white md:block"/>
                    </div>
                </div>
                <div className="p-7 pl-0 flex flex-col justify-between">
                    <div className="relative">
                        <h1 className="font-bold text-[clamp(6rem,8vw,8rem)] mb-0 text-white">Process</h1>
                        <h2 className="absolute top-0 left-3 text-start font-bold text-[clamp(2rem,5vw,3rem)] text-black">Our Company Work Process.</h2>
                        <h4 className="absolute bottom-15 left-3 text-zinc-500">Process</h4>
                    </div>
                    <div className="flex flex-col justify-between gap-7 pt-12 mt-5">
                        <div className="flex flex-col md:flex-row items-start pl-5 md:items-center gap-2 w-full md:w-[80%]">
                        ...
                        <div className="flex flex-col md:flex-row flex-col items-start pl-5 md:items-center gap-2 w-full md:w-[80%]">
