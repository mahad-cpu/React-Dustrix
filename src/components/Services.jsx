    ...
    return(
        <div>
            ...
            <div className="grid grid-cols md:grid-cols-2 lg:grid-cols-4 gap-3 p-7">
                <div className=" rounded-md bg-black flex flex-row items-center justify-center pt-12 pb-8 gap-5 hover:bg-zinc-600">
                    <div className="relative flex flex-col items-center justify-center">
                        <div className="rounded-full bg-amber-500 w-fit p-3">
                            <img src={sv1}/>
                        </div>
                        <h4 className="font-bold text-white">Quick Coordinate<br/>E-business</h4>
                        <a href="#" className="absolute top-35 left-1 w-full py-2 px-5 bg-amber-500 rounded-md">Learn More</a>
                    </div>
                </div>
                <div className=" rounded-md bg-black flex flex-row items-center justify-center pt-12 pb-8 gap-5 hover:bg-zinc-600">
                    <div className="relative flex flex-col items-center justify-center">
