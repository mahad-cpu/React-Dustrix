...
export default function Approach(){
    return(
        <section className="w-full flex flex-col items-center bg-zinc-800 py-12">
            <div className="w-full max-w-7xl p-12">
                <h1 className="text-8xl font-bold">Approach</h1>
                <h2 className="text-3xl font-bold">Capitalise On Hanging</h2><br/>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-6xl">
